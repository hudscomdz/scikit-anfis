...
class Bell_MF(MF_object):
    """
        Creates a Bell membership function.
    ...
    def __init__(self, a, b, c):
        ...
        self._b = b
        self._c = c
        if a <= 0: print("WARNING: sigma should be strictly positive, Simpful received sigma=%f" % a)

    def _execute(self, x):
        dist = np.power((x - self._c)/self._a, 2)
        return np.reciprocal(1 + np.power(dist, self._b))
...
class TriangleFuzzySet(FuzzySet):
    ...
    def get_params(self):
        return ['TriangularMembFunc', (self._funpointer._a, self._funpointer._b, self._funpointer._c)]
...
class TrapezoidFuzzySet(FuzzySet):
    ...
    def get_params(self):
        return ['TrapezoidalMembFunc', (self._funpointer._a, self._funpointer._b, self._funpointer._c, self._funpointer._d)]
...
class SigmoidFuzzySet(FuzzySet):
    ...
    def get_params(self):
        return ['SigmoidMembFunc', (self._funpointer._c, self._funpointer._a)]
...
class InvSigmoidFuzzySet(FuzzySet):
    ...
    def get_params(self):
        return ['InvSigmoidMembFunc', (self._funpointer._c, self._funpointer._a)]


class BellFuzzySet(FuzzySet):
    """
        Creates a new Bell fuzzy set.

        Args:
            a: mean of the distribution.
            b: standard deviation of the distribution.
            c: string representing the linguistic term to be associated to the fuzzy set.
    """

    def __init__(self, a, b, c, term):
        bell_MF = Bell_MF(a, b, c)
        super().__init__(function=bell_MF, term=term)
    ...
    def get_params(self):
        return ['BellMembFunc', (self._funpointer._a, self._funpointer._b, self._funpointer._c)]
...
class GaussianFuzzySet(FuzzySet):
    ...
    def get_params(self):
        return ['GaussMembFunc', (self._funpointer._mu, self._funpointer._sigma)]
...
class InvGaussianFuzzySet(FuzzySet):
    ...
    def get_params(self):
        return ['InvGaussMembFunc', (self._funpointer._mu, self._funpointer._sigma)]
...
class DoubleGaussianFuzzySet(FuzzySet):
    ...
    def get_params(self):
        return ['DoubleGaussMembFunc', (self._funpointer._mu1, self._funpointer._sigma1, self._funpointer._mu2, self._funpointer._sigma2)]
...
class CrispSet(FuzzySet):
    ...
    def get_params(self):
        return ['CrispMembFunc', (self._funpointer._left, self._funpointer._right)]
